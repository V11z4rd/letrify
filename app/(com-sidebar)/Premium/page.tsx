...
export default function PremiumPage() {
    ...
    const checarStatusUsuario = async () => {
      try {
        ...
        if (resposta.ok) {
          ...
          // Decodifica se o retorno de "premium" vier como '0'/'1', número ou booleano
          const statusPremium = Number(dadosDoUsuario.premium) === 1 || dadosDoUsuario.isPremium === true ? 1 : 0;
  ...
  // 3. ENVIAR REQUISIÇÃO DE ASSINATURA PRO (ROTA CORRIGIDA)
