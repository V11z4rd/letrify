...
export default function Sidebar() {
  return (
    <aside className="w-24 border-r border-gray-300 dark:border-gray-800 sticky top-0 self-start flex flex-col items-center py-8 min-h-screen justify-between" style={{ backgroundColor: 'var(--cor-fundo-sidebar)' }}>
      ...
      {/* TOPO: Logo que leva para o Feed */}
      <Link href="/feed" className="font-bold text-lg text-center hover:scale-105 transition-transform" style={{ backgroundColor: 'var(--cor-fundo-sidebar)', color: 'var(--cor-texto-sidebar)' }}>
        Letrify
      </Link>
      ...
      <nav className="flex flex-col gap-8 text-2xl items-center">
        ...
        {/* 2. AQUI ENTRA O NOSSO SININHO DE NOTIFICAÇÕES! */}
        <NotificacaoIcone />
